            ...
            <div className="w-full max-w-[420px] mx-auto">
                ...
                <div className="bg-white border border-gray-150 p-8 rounded-lg shadow-sm">
                    ...
                    <div className="space-y-3">
                        <button
                            onClick={() => {
                                toast.info("Redirecting to Google Sandbox authorization...");
                                setTimeout(() => {
                                    setEmail("amroypereira2003@gmail.com");
                    ...
                    <div className="mt-6 pt-5 border-t border-gray-100 text-center text-sm text-gray-500">
                        New to DivineSoul?{" "}
                        <Link to="/sign-up" className="text-violet-600 font-semibold hover:underline">
                            Create account
                        </Link>
                    </div>
                </div>
